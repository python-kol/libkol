...
class CharpaneRequest(GenericRequest):
    ...
    def parseResponse(self):
        ...
        characterAdventuresPattern = PatternManager.getOrCompilePattern(
            "characterAdventures"
        )
        ...
        characterMysticalityPattern = PatternManager.getOrCompilePattern(
            "characterMysticality"
        )
        ...
        characterMindControlPattern = PatternManager.getOrCompilePattern(
            "characterMindControl"
        )
