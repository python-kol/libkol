...
class SearchMallPriceRequest(GenericRequest):
    ...
    def parseResponse(self):
        ...
        mallPricesUnlimitedPattern = PatternManager.getOrCompilePattern(
            "mallPricesUnlimited"
        )
        ...
        for match in mallPricesUnlimitedPattern.finditer(self.responseText):
            ...
            price = {
                ...
                "count": match.group(4).replace(",", ""),
            }
            unlimited.append(price)
            price = {
                "price": match.group(5).replace(",", ""),
                "count": match.group(6).replace(",", ""),
            }
            unlimited.append(price)
            price = {
                "price": match.group(7).replace(",", ""),
                "count": match.group(8).replace(",", ""),
            }
            unlimited.append(price)

            item["unlimited"] = unlimited

        mallPricesLimitedPattern = PatternManager.getOrCompilePattern(
            "mallPricesLimited"
        )
        ...
        for match in mallPricesLimitedPattern.finditer(self.responseText):
            ...
            price = {
                ...
                "limit": match.group(5).replace(",", ""),
                "count": match.group(6).replace(",", ""),
            }
            limited.append(price)
            price = {
                "price": match.group(7).replace(",", ""),
                "limit": match.group(8).replace(",", ""),
                "count": match.group(9).replace(",", ""),
            }
            limited.append(price)
