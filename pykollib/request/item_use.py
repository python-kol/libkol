...
class item_use(Request[str]):
    ...
    def __init__(self, session: "pykollib.Session", item: Item) -> None:
        ...
        self.request = session.request("inv_use.php", ajax=True, pwd=True, params=params)
    ...
    async def parser(content: str, **kwargs) -> str:
        ...
        if "<blockquote>This item is not implemented yet.  Try again later.</blockquote>" in content:
