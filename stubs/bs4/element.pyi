# Stubs for bs4.element (Python 3)
#
...
class NamespacedAttribute(str):
    def __new__(cls, prefix: Any, name: Any, namespace: Optional[Any] = ...): ...
...
class HTMLAwareEntitySubstitution(EntitySubstitution):
    ...
    preformatted_tags: Any = ...
    preserve_whitespace_tags: Any = ...
    @classmethod
    def substitute_html(cls, ns: Any): ...
    @classmethod
    def substitute_xml(cls, ns: Any): ...

class Formatter:
    void_element_close_prefix: str = ...
    def substitute_entities(self, *args: Any, **kwargs: Any) -> None: ...

class HTMLFormatter(Formatter):
    def substitute(self, *args: Any, **kwargs: Any): ...
...
class PageElement:
    HTML_FORMATTERS: Any = ...
    XML_FORMATTERS: Any = ...
    def format_string(self, s: Any, formatter: str = ...): ...
    parent: Any = ...
...
class Tag(PageElement):
    ...
    def __init__(self, parser: Optional[Any] = ..., builder: Optional[Any] = ..., name: Optional[Any] = ..., namespace: Optional[Any] = ..., prefix: Optional[Any] = ..., attrs: Optional[Any] = ..., parent: Optional[Any] = ..., previous: Optional[Any] = ..., is_xml: Optional[Any] = ...) -> None: ...
    parserClass: Any = ...
    def __copy__(self): ...
    @property
