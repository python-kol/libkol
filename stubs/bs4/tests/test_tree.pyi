# Stubs for bs4.tests.test_tree (Python 3)
#
...
class TreeTest(SoupTest):
    def assertSelects(self, tags: Any, should_match: Any) -> None: ...
    def assertSelectsIDs(self, tags: Any, should_match: Any) -> None: ...
...
class TestElementObjects(SoupTest):
    ...
    def test_get_text_ignores_comments(self) -> None: ...
    def test_all_strings_ignores_comments(self) -> None: ...
...
class TestSoupSelector(TreeTest):
    ...
    soup: Any = ...
    def setUp(self) -> None: ...
    def assertSelects(self, selector: Any, expected_ids: Any, **kwargs: Any) -> None: ...
    assertSelect: Any = ...
    def assertSelectMultiple(self, *tests: Any) -> None: ...
